...
- AI Engineering from Scratch, Phase 13 · Lessons 06-18 (MCP deep dive, security, gateway) — [GitHub](https://github.com/rohitg00/ai-engineering-from-scratch/tree/main/phases/13-tools-and-protocols)
- [[en/AI/sources/Agent_Tools_&_Interoperability_with_Model_Context_Protocol_(MCP)|Agent Tools & MCP]] (existing wiki source, first published Nov 2025 → updated May 2026)
- [[en/AI/sources/Prototype_to_Production|Prototype_to_Production]] (MCP vs A2A comparison, first published Nov 2025 → updated May 2026)
