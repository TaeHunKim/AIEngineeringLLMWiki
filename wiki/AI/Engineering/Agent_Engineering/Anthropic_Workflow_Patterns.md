...
"Effective context engineering for AI agents" (Anthropic, 2025)는 이 워크플로 패턴들의 인접 분야를 공식화한다: 컨텍스트 창(200K 토큰 등)은 담을 수 있는 "그릇"이 아니라 관리해야 할 "예산"이다. 무엇을 포함할지, 언제 압축할지 결정하는 문제 → [[AI/Engineering/Context_Engineering/Context_Engineering|Context Engineering]]
