...
- [[AI/Engineering/Flow_Engineering/Graph_Flow/Graph_Flow|Graph Flow]] — LangGraph의 **구현 메커니즘**(StateGraph, 조건부 엣지, 순환 플로우, ReAct, Human-in-the-Loop). "그래프를 어떻게 코드로 짜는가"에 대한 답.
- [[AI/Engineering/Context_Engineering/Retrieval_Strategies/GraphRAG/GraphRAG|GraphRAG]] / [[AI/Engineering/Context_Engineering/Retrieval_Strategies/GraphRAG/Knowledge_Graph/Knowledge_Graph|Knowledge Graph]] — **데이터** 그래프. 엔티티-관계를 저장·검색하는 구조. "무엇을 검색하는가"에 대한 답.
